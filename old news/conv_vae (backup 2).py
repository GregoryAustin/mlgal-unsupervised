...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(1, 32, kernel_size=2, stride=2, padding=0)
...
def loss_function(recon_x, x, mu, logvar):
    BCE = F.binary_cross_entropy(recon_x.view(-1, 32 * 32 * 1),
                                 x.view(-1, 32 * 32 * 1), size_average=False)
